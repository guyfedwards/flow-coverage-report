...
function FlowCoverageLocsForm(props) {
  ...
  var threshold = coverageSummaryData.threshold,
      thresholdUncovered = coverageSummaryData.thresholdUncovered;
  ...
  if (props.htmlTemplateOptions && props.htmlTemplateOptions.showMeterBar) {
    meterBar = _react2.default.createElement(_coverageMeterBar2.default, { percent: percent, threshold: threshold, thresholdUncovered: thresholdUncovered, uncoveredCount: uncovered_count });
  }
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_coverageFileTableRow2.default, {
              ...
              percent: percent,
              threshold: threshold,
              thresholdUncovered: thresholdUncovered,
              /* eslint-disable camelcase */
