...
function renderTextReport(coverageData, opts) {
  ...
  var thresholdValue = coverageData.thresholdUncovered ? ['thresholdUncovered', coverageData.thresholdUncovered] : ['threshold', coverageData.threshold];
